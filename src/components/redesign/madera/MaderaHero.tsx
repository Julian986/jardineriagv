...
import { ArrowLeft, Hammer, Recycle, Ruler } from "lucide-react";
import { HistoryBackLink } from "@/components/HistoryBackLink";
import {
  MADERA_HERO_BADGE,
  MADERA_HERO_DESCRIPCION,
  MADERA_HERO_IMAGEN,
  MADERA_HERO_TITULO_LINEA1,
  MADERA_HERO_TITULO_LINEA2,
  MADERA_META,
  MADERA_TAGLINE,
  ...
  return (
    <section className="relative flex min-h-[420px] flex-col justify-end overflow-hidden md:min-h-[520px] lg:min-h-[560px]">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 pb-0 pt-24 md:px-6 md:pt-28">
        ...
        <p className="mt-3 text-sm font-semibold text-[#e8c88a]/95">{MADERA_TAGLINE}</p>
      </div>
